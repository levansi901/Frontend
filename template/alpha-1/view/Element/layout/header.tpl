<header class="mn-header navbar-fixed">
    <nav class="teal lighten-1 nav-top">
        <div class="nav-wrapper row">
            ...
            <div class="header-title col s5 m3">
                <span class="chapter-title">S-Sale</span>
            </div>

            <ul class="right col s7 m3 nav-right-menu">
                <li>
                ...
                <li>
                    <a href="javascript:void(0)" data-activates="list-notifications" class="dropdown-button dropdown-right show-on-large">
                        <i class="material-icons">notifications_none</i><span class="badge">4</span>
                    </a>
                </li>
            </ul>
            
            <ul id="list-notifications" class="dropdown-content notifications-dropdown">
